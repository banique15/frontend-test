...
export default function ProgramInfo() {
  return (
    <div className="mx-auto w-full bg-white space-y-16 sm:space-y-20 lg:mx-0 lg:max-w-none">
      <div>
      ...
      <div>
        ...
        <p className="mt-1 text-sm leading-6 text-gray-500">Choose what language and date format to use throughout your account.</p>
